...
export class KnowledgeService {
  ...
  // ========================================================================
  // Phase 2 additive methods — kb-id based + persona aggregation.
  // Older persona-id methods remain for backward compatibility and will be
  // removed in Phase 2 Task 7 after AgentService has switched over.
  // ========================================================================
